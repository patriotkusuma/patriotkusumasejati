...
function Footer() {
  return (
    <div className=" w-full flex flex-col gap-y-2 font-light  dark:bg-gray-800 bg-gray-200 backdrop-blur-xl md:py-2 hover:shadow-white/20 md:px-8 p-4 rounded-2xl duration-500 ease-in-out">
