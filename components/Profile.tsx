  ...
  return (
    <div className="flex flex-col justify-start items-center mx-auto gap-y-4">
      ...
      <div className="text-left">
        <h1 className="text-white font-bold xl:text-2xl text-xl mb-2 ">
        ...
        <div className="text-white/90 font-light mt-2 inline-flex place-self-start gap-x-2 w-full">
          <Link
            href="https://github.com/patriotkusuma"
            className="text-gray-400 hover:text-gray-200 duration-500 ease-in-out transition-all"
            target="_blank"
          >
      ...
      <Link
        ...
        target="_blank"
        className="py-2 w-full  text-center ease-in-out duration-500 bg-yellow-700 rounded-xl block hover:bg-yellow-800 cursor-pointer"
      >
        Contact Me
      </Link>
      <TimelineEducation />
