...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col md:flex-row gap-y-5  justify-between md:px-10 mx-auto   p-6 md:gap-x-5">
      <div className="md:basis-1/4 basis-full dark:bg-gray-800 bg-white/80 backdrop-blur-2xl filter-blur-5 md:py-12 hover:shadow-white/20 dark:backdrop-blur-sm  flex items-start md:px-3 p-4 rounded-3xl hover:shadow-2xl duration-500 ease-in-out">
        <Profile />
      </div>
